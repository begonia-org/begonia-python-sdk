...
class FileAPIGrpcClient:
    ...
    def get_file(self, fid: str, read_request: ReadFileRequest = None) -> Tuple[FileDetails, io.BytesIO]:
        request = DownloadRequest(
            ...
            version=read_request.version,
            bucket=read_request.bucket,
            engine=read_request.engine)
...
if __name__ == "__main__":
    client = FileAPIGrpcClient("127.0.0.1", 12139, "6Yalu1yVFAq2bYhxEq7lT9CEGc24nMgh",
                               "aF6z12wadvu0RfWhtEx3pCcqlUYN8IAPhbSa1rTfLDJ0SFaMaovLmXIq6ucksvPR")
    file, data = client.get_file("", ReadFileRequest(engine=FILE_ENGINE_MINIO,
                                 bucket="bucket-minio-biz-20240615020417", key="test.txt", version=""))
    print(file)
