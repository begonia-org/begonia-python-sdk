...
class HelloSubRequest(_message.Message):
    __slots__ = ("sub_msg", "sub_name", "update_mask")
    ...
    def __init__(self, sub_msg: _Optional[str] = ..., sub_name: _Optional[str] = ..., update_mask: _Optional[_Union[_field_mask_pb2.FieldMask, _Mapping]] = ...) -> None: ...

class HelloRequestWithValidator(_message.Message):
    __slots__ = ("msg", "name", "age", "sub", "subs", "update_mask")
    MSG_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    update_mask: _field_mask_pb2.FieldMask
    def __init__(self, msg: _Optional[str] = ..., name: _Optional[str] = ..., age: _Optional[int] = ..., sub: _Optional[_Union[HelloSubRequest, _Mapping]] = ..., subs: _Optional[_Iterable[_Union[HelloSubRequest, _Mapping]]] = ..., update_mask: _Optional[_Union[_field_mask_pb2.FieldMask, _Mapping]] = ...) -> None: ...
